                ...
                <div className="relative">
                    ...
                    >
                        <div className="flex flex-col items-end">
                            <span className="font-semibold text-[13px] text-gray-900">{user?.fullName || 'Administrator'}</span>
                            <span className="text-gray-500 text-[11.5px]">Admin</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-gradient-to-br from-blue-500 to-indigo-700 text-white text-xs font-bold flex items-center justify-center shrink-0 ring-2 ring-white shadow-sm">
