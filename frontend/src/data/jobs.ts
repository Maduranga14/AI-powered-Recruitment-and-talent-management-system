...
export interface Job {
  ...
  benefits: string[];
  applicants: number;
  /** AI match score 0-100 relative to the demo candidate profile */
  matchScore: number;
  featured?: boolean;
}
...
},
{
  ...
  shortDescription:
  'Build reliable, scalable services that power our data-intensive platform.',
  responsibilities: [
