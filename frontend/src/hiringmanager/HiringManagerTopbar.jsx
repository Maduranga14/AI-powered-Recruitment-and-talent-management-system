...
export default function HiringManagerTopbar({ user, onLogout }) {
    ...
    return (
        <header className="h-16 bg-white border-b border-gray-200 flex items-center px-7 gap-4 sticky top-0 z-40">
            ...
            <div className="flex items-center gap-2.5 bg-gray-100 rounded-full px-4 py-2 flex-1 max-w-[400px] text-gray-400">
                ...
                <input
                    type="text"
                    placeholder="Search candidates, reviews, interviews..."
                    value={search}
                ...
                <div className="relative">
                    ...
                    >
                        <div className="flex flex-col items-end">
                            <span className="font-semibold text-[13px] text-gray-900">{user?.fullName || 'Hiring Manager'}</span>
                            <span className="text-gray-500 text-[11.5px]">Hiring Manager</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-gradient-to-br from-teal-400 to-cyan-600 text-white text-xs font-bold flex items-center justify-center shrink-0 ring-2 ring-white shadow-sm">
