...
export default function HiringManagerTopbar() {
    ...
    <header className="h-16 bg-white border-b border-gray-200 flex items-center px-7 gap-4 sticky top-0 z-9">
      ...
      <div className="flex items-center gap-4 ml-auto">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div className="w-9 h-9 rounded-full bg-gradient-to-br from-blue-400 to-indigo-600 text-white text-xs font-bold flex items-center justify-center shrink-0 ring-2 ring-white shadow-sm">
            AT
          </div>
        </div>
      </div>
